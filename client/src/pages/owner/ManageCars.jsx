...
const ManageCars = () => {
  ...
  const {isOwner, axios, currency, fetchCars, apiErrorMessage} = useAppContext()
            ...
            {cars.map((car, index)=>(
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='p-3 flex items-center gap-3'>
                  <img src={car.image || fallbackCarImage(car)} onError={(event) => handleCarImageError(event, car)} alt="" className="h-12 w-12 aspect-square rounded-md object-cover"/>
