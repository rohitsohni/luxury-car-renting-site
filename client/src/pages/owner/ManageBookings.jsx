...
const ManageBookings = () => {
  ...
  const { currency, axios, apiErrorMessage } = useAppContext()
            ...
            {bookings.map((booking, index)=>(
              <tr key={index} className='border-t border-borderColor text-gray-500'>
                ...
                <td className='p-3 flex items-center gap-3'>
                  <img src={booking.car.image || fallbackCarImage(booking.car)} onError={(event) => handleCarImageError(event, booking.car)} alt="" className='h-12 w-12 aspect-square rounded-md object-cover'/>
