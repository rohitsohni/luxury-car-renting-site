...
const CarDetails = () => {
  ...
  const {cars, axios, pickupDate, setPickupDate, returnDate, setReturnDate, apiErrorMessage} = useAppContext()
  ...
  const handleSubmit = async (e)=>{
    ...
    if (!isMongoObjectId(id)) {
      toast.error('Please wait for the live car inventory to load, then choose the car again')
      return
    }
